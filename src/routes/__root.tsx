...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "RENOVAL — Tarimas, Huacales y Componentes CNC" },
      { property: "og:description", content: "Soluciones industriales de embalaje de madera. Tarimas, huacales y componentes CNC a la medida." },
